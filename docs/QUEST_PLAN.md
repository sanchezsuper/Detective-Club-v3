...
**Лист Олені** — готовий до друку файл: `props/letter.html` (кнопка «Роздрукувати»; вшитий шрифт Bad Script — оцифрований справжній почерк; старений папір, лінії згину, слід від чашки) + прев'ю `props/letter.png`. Текст:
