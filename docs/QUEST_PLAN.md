...
- Історія служби: з 2022-го керівник закритого напряму **«ГЛИБИНА»** — легендування, контрольовані зникнення, виведення агентів з-під удару; 11 операцій без жодного провалу; за атестацією — **найкращий у Службі фахівець з інсценувань** (форшадовінг твісту!); останнє завдання настільки секретне, що матеріали знищені навіть в архіві; двічі подавав рапорт про загрозу життю — і сам його відкликав
- Жодних прямих підказок про телефон у записці немає (прибрано за вашим рішенням)

### Крок 8-Б · Телефон жертви
Гравці повертаються до заблокованого телефона і мають **самі здогадатися** спробувати дату народження: `19.08` → код **1908** → телефон відкривається (страховка на випадок ступору — усна підказка диспетчера):
