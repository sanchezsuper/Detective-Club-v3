...
- нотатки **«Периметр»** ✅ фінальні: `Т-1: 59-км — 1520 м · Т-2: Блакитні озера — 853 м · Т-3: Детектив П — 750 м`; службовий рядок про «точку Х» прибрано — що робити з місцями і радіусами, гравці здогадуються самі (циркуль + паперова мапа)
...
| 8 | ~~Точки тріангуляції~~ | ✅ ГОТОВО: реальні місця підставлені в СХОВИЩЕ-7 (59-км · Блакитні озера · Детектив П). Онлайн-частина повністю боєготова |
...
flowchart TD
    ...
    D3 --> E2
    E2 --> E2b["Нотатки «Периметр»: 3 місця-орієнтири з радіусами.<br/>Галерея і документи — порожні"]
