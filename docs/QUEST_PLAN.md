...
2. **Фото «proof of life»**: він, живий, тримає газету, дата на шапці — після «смерті». Найжорсткіший доказ, зрозумілий без пояснень
...
**Лист Олені** — готовий до друку файл: `props/letter.html` (кнопка «Роздрукувати»; вшитий рукописний шрифт, старений папір, лінії згину, слід від чашки) + прев'ю `props/letter.png`. Текст:
