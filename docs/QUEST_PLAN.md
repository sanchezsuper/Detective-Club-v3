...
3. ✅ **Вирішено: лише одне завдання-допуск.** Реєстрація → одне завдання → вхід до кабінету детектива. Роздачу ролей (Криптограф, Картограф, Аналітик, Технік) переносимо в кабінет: після СТАРТу кожен бачить свою роль у брифінгу — без додаткових задач, що палять час.
...
- ✅ **Друга онлайн-задача прибрана** — лишається одне завдання-допуск до кабінету. Все інше — на вулицю.
...
flowchart TD
    subgraph S0["ЕТАП 0 · Онлайн-допуск"]
        ...
        A2 --> A3["Одне завдання-допуск"]
        A3 --> A4["Кабінет детектива: допуск отримано"]
        A4 --> A5["Лобі: видно, хто готовий"]
    end
    A5 --> B1{"Ведучий тисне СТАРТ"}
    B1 --> B2["Зворотний відлік ~3 год"]
    B2 --> B4["БРИФІНГ у кабінеті: справа офіцера,<br/>замовниця — дружина.<br/>Кожен бачить свою роль:<br/>Криптограф · Картограф · Аналітик · Технік"]
...
2. Форма реєстрації детектива (ім'я + аватар).
3. Одне завдання-допуск → вхід до кабінету детектива.
4. Кабінет детектива: лобі зі статусами, зворотний відлік, кнопка СТАРТ у ведучого.
5. Вивід тексту основного завдання (брифінг) + роль детектива.
