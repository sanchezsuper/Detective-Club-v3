...
- **Речдок № 4 · Телефон** — знайдений, але **мертвий**: розбитий екран, «ПРИСТРІЙ ЗАШИФРОВАНО». Не входить у PIN. Глухий кут навмисно — доступ до даних з'явиться лише через систему Служби
