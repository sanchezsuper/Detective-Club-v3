...
- **Речдок № 4 · Телефон** ✅ (`props/rechdok-4-telefon.png`) — знайдений, але **мертвий**: розбитий екран, «ПРИСТРІЙ ЗАШИФРОВАНО». Не входить у PIN. Глухий кут навмисно — доступ до даних з'явиться лише через систему Служби

> Чому телефон не дає цифр PIN: щоб гравці не плуталися в зайвих числах. Джерела PIN — три чисті артефакти з номерами: годинник, клаптик, планка зброї.
...
- **Примітка технічного відділу:** «через неможливість запуску телефону вся система перенесена у хмару; повна копія пристрою майора: **СХОВИЩЕ-7**» (клікабельне посилання прямо в розсекреченому тексті). Про доступ — ні слова: що вводити в PIN-екран, гравці здогадуються самі по даті народження (страховка — диспетчер)
...
- пропущений виклик від **«О.»** (без часу; він не відповів дружині — чистий флейвор)
- кнопка **«← ДОСЬЄ»** над телефоном: навігація двостороння — з досьє за посиланням СХОВИЩЕ-7, назад одним кліком; стан досьє зберігається (розсекречений текст на місці)
- **галерея порожня, документів немає** — все стерто; вцілiли лише нотатки і виклики (натяк: він чистив телефон сам)
- у повідомленнях лише невідправлена чернетка: «годинник підкаже прав…» (чат прибрано — незрозуміло, хто писав)
- нотатки ✅ фінальні: `Т-1: Баня на Блакитних — 1000 м · Т-2: Агент П — 750 м · Т-3: Баня на Заливній — 1125 м`; службовий рядок про «точку Х» прибрано — що робити з місцями і радіусами, гравці здогадуються самі (циркуль + паперова мапа)
...
(«Годинник не бреше» — гачок на твіст 2.)
...
| 3 | ~~Зброя~~ | ✅ ВИРІШЕНО (ваше рішення): зброя — **основний** доказ, планка «SXTN 12» дає останні 2 цифри PIN |
| 4 | ~~Ролі~~ | ✅ ВИРІШЕНО (ваше рішення): ролі прибрані повністю — ні механіки, ні бейджів |
| 5 | ~~Дзвінок / бонус-зачіпки~~ | ✅ ВИРІШЕНО (ваше рішення): бонус-зачіпки прибрані повністю (щоб не перевантажувати); пропущений виклик — без часу, просто від «О.» |
...
| 8 | ~~Точки тріангуляції~~ | ✅ ГОТОВО: реальні місця підставлені в СХОВИЩЕ-7 (Баня на Блакитних 1000 м · Агент П 750 м · Баня на Заливній 1125 м). Онлайн-частина повністю боєготова |
...
ОНЛАЙН (термінал, кнопка «i»):
  Завдання Л → ЛОГІН (СОКІЛ)     Завдання П → ПАРОЛЬ (2482)
...
flowchart TD
    ...
    C["ФАЗА C · Реквізит<br/>— фото-речдоки: 3 полароїди ✅ (папка props/)<br/>— паперове досьє + маркер + UV-написи<br/>— годинник (зупинити на 21:47)<br/>— піджак: клаптик «…53…»<br/>— «телефон»-реквізит з QR на сторінку<br/>— зброя з планкою «SXTN 12»<br/>— колесо шифру, паперова мапа<br/>— посвідчення «Мирон Гай» + лист<br/>— поліцейська стрічка, конверти"]
...
flowchart TD
    ...
    D3 --> E2
    E2 --> E2b["Нотатки: 3 місця-орієнтири з радіусами.<br/>Галерея і документи — порожні"]
